...
"""
Setting setup will construct certain setting catalogs during runtime
...
def load_configuration(path,
                       ...
                       allow_unknown=False,
                       allow_known=True):
    old_settings = Catalogs['defaults']
    new_settings = load_settings_from_file(path, old_settings)
    return _load_configuration(new_settings,
                               source=path,
...
def _load_configuration(new_settings,
                        source='unknown',
                        allow_override=False,
                        allow_unknown=False,
                        allow_known=True):
...
class Setting(object):
    ...
    ** STATE ATTRIBUTES **
    ...
    def __init__(self, **kwargs):
        ...
        if isinstance(init_dependencies, basestring):
