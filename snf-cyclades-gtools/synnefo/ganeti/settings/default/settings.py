...
BACKEND_PREFIX_ID = Default(
    ...
    description=(
        "Ganeti instances that run on this backend and their name "
        "starts with this prefix will be considered as Synnefo managed. "
        "Thus, corresponding notifications for those instances will be "
