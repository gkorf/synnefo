...
cyclades_patterns = api_patterns(
    '',
    (prefix_pattern(VMAPI_PREFIX), include('synnefo.cyclades.vmapi.urls')),
    (prefix_pattern(PLANKTON_PREFIX), include('synnefo.cyclades.plankton.urls')),
    (prefix_pattern(COMPUTE_PREFIX), include('synnefo.cyclades.api.compute_urls')),
    (prefix_pattern(NETWORK_PREFIX), include('synnefo.cyclades.api.network_urls')),
    (prefix_pattern(USERDATA_PREFIX), include('synnefo.cyclades.userdata.urls')),
    (prefix_pattern(ADMIN_PREFIX), include('synnefo.cyclades.admin.urls')),
    (prefix_pattern(VOLUME_PREFIX), include('synnefo.cyclades.volume.urls')),
)
...
cyclades_patterns += api_patterns(
    '',
    (prefix_pattern(HELPDESK_PREFIX), include('synnefo.cyclades.helpdesk.urls')),
)
