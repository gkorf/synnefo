...
MESSAGES_VIEWS_MAP = getattr(settings, 'ASTAKOS_MESSAGES_VIEWS_MAP', {
    'synnefo.astakos.im.views.index': 'LOGIN_MESSAGES',
    'synnefo.astakos.im.views.logout': 'LOGIN_MESSAGES',
    'synnefo.astakos.im.views.login': 'LOGIN_MESSAGES',
    'synnefo.astakos.im.views.signup': 'SIGNUP_MESSAGES',
    'synnefo.astakos.im.views.edit_profile': 'PROFILE_MESSAGES',
    'synnefo.astakos.im.views.change_password': 'PROFILE_MESSAGES',
    'synnefo.astakos.im.views.invite': 'PROFILE_MESSAGES',
    'synnefo.astakos.im.views.feedback': 'PROFILE_MESSAGES',
})
