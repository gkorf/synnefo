...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('im_resource', 'uplimit', self.gf('synnefo.django.lib.db.fields.IntDecimalField')(default=0, max_digits=38, decimal_places=0), keep_default=False)

        # Changing field 'AstakosUserQuota.capacity'
        db.alter_column('im_astakosuserquota', 'capacity', self.gf('synnefo.django.lib.db.fields.IntDecimalField')(default=0, max_digits=38, decimal_places=0))

        # Changing field 'AstakosUserQuota.import_limit'
        db.alter_column('im_astakosuserquota', 'import_limit', self.gf('synnefo.django.lib.db.fields.IntDecimalField')(max_digits=38, decimal_places=0))

        # Changing field 'AstakosUserQuota.export_limit'
        db.alter_column('im_astakosuserquota', 'export_limit', self.gf('synnefo.django.lib.db.fields.IntDecimalField')(max_digits=38, decimal_places=0))

        # Changing field 'AstakosUserQuota.quantity'
        db.alter_column('im_astakosuserquota', 'quantity', self.gf('synnefo.django.lib.db.fields.IntDecimalField')(max_digits=38, decimal_places=0))
    ...
    models = {
        ...
        'im.astakosuserquota': {
            ...
            'export_limit': ('synnefo.django.lib.db.fields.IntDecimalField', [], {'default': '100000000000000000000000000000000L', 'max_digits': '38', 'decimal_places': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_limit': ('synnefo.django.lib.db.fields.IntDecimalField', [], {'default': '100000000000000000000000000000000L', 'max_digits': '38', 'decimal_places': '0'}),
            'quantity': ('synnefo.django.lib.db.fields.IntDecimalField', [], {'default': '0', 'max_digits': '38', 'decimal_places': '0'}),
        ...
        'im.projectresourcegrant': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member_capacity': ('synnefo.django.lib.db.fields.IntDecimalField', [], {'default': '100000000000000000000000000000000L', 'max_digits': '38', 'decimal_places': '0'}),
            'member_export_limit': ('synnefo.django.lib.db.fields.IntDecimalField', [], {'default': '100000000000000000000000000000000L', 'max_digits': '38', 'decimal_places': '0'}),
            'member_import_limit': ('synnefo.django.lib.db.fields.IntDecimalField', [], {'default': '100000000000000000000000000000000L', 'max_digits': '38', 'decimal_places': '0'}),
            'project_application': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['im.ProjectApplication']", 'null': 'True'}),
            'project_capacity': ('synnefo.django.lib.db.fields.IntDecimalField', [], {'default': '100000000000000000000000000000000L', 'max_digits': '38', 'decimal_places': '0'}),
            'project_export_limit': ('synnefo.django.lib.db.fields.IntDecimalField', [], {'default': '100000000000000000000000000000000L', 'max_digits': '38', 'decimal_places': '0'}),
            'project_import_limit': ('synnefo.django.lib.db.fields.IntDecimalField', [], {'default': '100000000000000000000000000000000L', 'max_digits': '38', 'decimal_places': '0'}),
            'resource': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['im.Resource']"})
        },
        'im.resource': {
