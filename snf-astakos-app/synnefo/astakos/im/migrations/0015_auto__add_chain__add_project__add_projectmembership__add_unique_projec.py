...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('im_projectresourcegrant', (
            ...
            ('project_capacity', self.gf('synnefo.django.lib.db.fields.IntDecimalField')(default=100000000000000000000000000000000L, max_digits=38, decimal_places=0)),
            ('project_import_limit', self.gf('synnefo.django.lib.db.fields.IntDecimalField')(default=100000000000000000000000000000000L, max_digits=38, decimal_places=0)),
            ('project_export_limit', self.gf('synnefo.django.lib.db.fields.IntDecimalField')(default=100000000000000000000000000000000L, max_digits=38, decimal_places=0)),
            ('member_capacity', self.gf('synnefo.django.lib.db.fields.IntDecimalField')(default=100000000000000000000000000000000L, max_digits=38, decimal_places=0)),
            ('member_import_limit', self.gf('synnefo.django.lib.db.fields.IntDecimalField')(default=100000000000000000000000000000000L, max_digits=38, decimal_places=0)),
            ('member_export_limit', self.gf('synnefo.django.lib.db.fields.IntDecimalField')(default=100000000000000000000000000000000L, max_digits=38, decimal_places=0)),
        ))
